...
int main(int argc, char *argv[]) {
  ...
  struct option long_options[] = {
      ...
      {"eps-gap", required_argument, 0, CLI_OPT_EPS_GAP},
      ...
      {"grid-size", required_argument, 0, 'z'},
      {"output-dir", required_argument, 0, 'O'},
      {"help", no_argument, 0, 'h'},
      {"l-inf-ruiz-iter", required_argument, 0, CLI_OPT_L_INF_RUIZ_ITER},
      {"no-pock-chambolle", no_argument, 0, CLI_OPT_NO_POCK_CHAMBOLLE},
      {"pock-chambolle-alpha", required_argument, 0,
       CLI_OPT_POCK_CHAMBOLLE_ALPHA},
      {"no-bound-obj-rescaling", no_argument, 0,
       CLI_OPT_NO_BOUND_OBJ_RESCALING},
      {"no-scaling", no_argument, 0, CLI_OPT_NO_SCALING},
      {"psd-scale-mode", required_argument, 0, CLI_OPT_PSD_SCALE_MODE},
      {0, 0, 0, 0}};
