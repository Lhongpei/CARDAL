...
int parse_arguments(int argc, char *argv[], char **filename,
  ...
  struct option long_options[] = {{"file", required_argument, 0, 'f'},
                                  ...
                                  {"eps-primal", required_argument, 0,
                                   CLI_OPT_EPS_PRIMAL},
                                  {"eps-dual", required_argument, 0,
                                   CLI_OPT_EPS_DUAL},
                                  {"eps-gap", required_argument, 0,
                                   CLI_OPT_EPS_GAP},
                                  ...
                                  {"l-inf-ruiz-iter", required_argument, 0,
                                   CLI_OPT_L_INF_RUIZ_ITER},
                                  {"no-pock-chambolle", no_argument, 0,
                                  ...
                                  {"no-scaling", no_argument, 0,
                                   CLI_OPT_NO_SCALING},
                                  {"psd-scale-mode", required_argument, 0,
